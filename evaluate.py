...
def main():
    ...
    with open('C:/Users/Ritu/PycharmProjects/CVIP1/Project1/results.json') as file:
        preds = json.load(file)

    with open('C:/Users/Ritu/PycharmProjects/CVIP1/Project1/data/groundtruth.json') as file:
